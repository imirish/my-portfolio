<template>
  <section class="tw-py-20 tw-bg-[#F2B5D4] tw-text-center">
    <h2 class="tw-text-xl tw-font-bold tw-mb-8 tw-text-[#1E1E2E]">Skills</h2>
    <div
      class="tw-grid tw-grid-cols-3 sm:tw-grid-cols-6 tw-gap-6 tw-max-w-4xl tw-mx-auto tw-text-[#1E1E2E]"
    >
